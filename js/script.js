(function ($) {
	...
	*/
	...
	// 	$(this).closest(".accordion").toggleClass("item-active").siblings().removeClass("item-active");
	// });

	$('.accordion').find('.acc-btn').on('click', function () {
		$(this).toggleClass('item-active');
		$(this).next().slideToggle('fast');
		$('.acc-content').not($(this).next()).slideUp('fast');
		$('.acc-btn').not($(this)).removeClass('item-active');
	});
